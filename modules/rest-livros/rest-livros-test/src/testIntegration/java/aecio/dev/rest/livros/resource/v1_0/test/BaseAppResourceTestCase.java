package aecio.dev.rest.livros.resource.v1_0.test;

import aecio.dev.rest.livros.client.dto.v1_0.App;
import aecio.dev.rest.livros.client.http.HttpInvoker;
import aecio.dev.rest.livros.client.pagination.Page;
import aecio.dev.rest.livros.client.resource.v1_0.AppResource;
import aecio.dev.rest.livros.client.serdes.v1_0.AppSerDes;
...
public abstract class BaseAppResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		app.setAppId(regex);
		app.setDescription(regex);
		app.setLink(regex);
		app.setLogoUrl(regex);
		app.setName(regex);
		...
		Assert.assertEquals(regex, app.getAppId());
		Assert.assertEquals(regex, app.getDescription());
		Assert.assertEquals(regex, app.getLink());
		Assert.assertEquals(regex, app.getLogoUrl());
		Assert.assertEquals(regex, app.getName());
	}

	@Test
	public void testGetApps() throws Exception {
		Page<App> page = appResource.getApps();

		long totalCount = page.getTotalCount();

		App app1 = testGetApps_addApp(randomApp());

		App app2 = testGetApps_addApp(randomApp());

		page = appResource.getApps();
	...
	protected App testGetApps_addApp(App app) throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	@Test
	public void testGraphQLGetApps() throws Exception {
	...
	public void testAddApp() throws Exception {
		...
		App postApp = testAddApp_addApp(randomApp);

		assertEquals(randomApp, postApp);
		assertValid(postApp);
	}

	protected App testAddApp_addApp(App app) throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(aecio.dev.rest.livros.dto.v1_0.App.class)) {
	...
	protected boolean equals(App app1, App app2) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("appId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(app1.getAppId(), app2.getAppId())) {
					return false;
				}
			...
			if (Objects.equals("description", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						app1.getDescription(), app2.getDescription())) {
			...
			if (Objects.equals("link", additionalAssertFieldName)) {
				if (!Objects.deepEquals(app1.getLink(), app2.getLink())) {
					return false;
				}
			...
			if (Objects.equals("logoUrl", additionalAssertFieldName)) {
				if (!Objects.deepEquals(app1.getLogoUrl(), app2.getLogoUrl())) {
					return false;
				}
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("appId")) {
			sb.append("'");
			sb.append(String.valueOf(app.getAppId()));
			sb.append("'");
		...
		if (entityFieldName.equals("description")) {
			sb.append("'");
			sb.append(String.valueOf(app.getDescription()));
			sb.append("'");
		...
		if (entityFieldName.equals("link")) {
			sb.append("'");
			sb.append(String.valueOf(app.getLink()));
			sb.append("'");
		...
		if (entityFieldName.equals("logoUrl")) {
			sb.append("'");
			sb.append(String.valueOf(app.getLogoUrl()));
			sb.append("'");
		...
		if (entityFieldName.equals("name")) {
			sb.append("'");
			sb.append(String.valueOf(app.getName()));
			sb.append("'");
	...
	protected App randomApp() throws Exception {
		return new App() {
			{
				appId = StringUtil.toLowerCase(RandomTestUtil.randomString());
	...
	@Inject
	private aecio.dev.rest.livros.resource.v1_0.AppResource _appResource;

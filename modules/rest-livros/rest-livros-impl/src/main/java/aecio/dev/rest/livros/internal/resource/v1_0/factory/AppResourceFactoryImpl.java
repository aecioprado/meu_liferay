package aecio.dev.rest.livros.internal.resource.v1_0.factory;
...
public class AppResourceFactoryImpl implements AppResource.Factory {
	...
	public AppResource.Builder create() {
		return new AppResource.Builder() {
			...
			public AppResource build() {
				...
				return _appResourceProxyProviderFunction.apply(
			...
			@Override
			public AppResource.Builder httpServletResponse(
	...
	private static Function<InvocationHandler, AppResource>
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			AppResource.class.getClassLoader(), AppResource.class);

		try {
			Constructor<AppResource> constructor =
				(Constructor<AppResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		appResource.setContextHttpServletResponse(httpServletResponse);
		appResource.setContextUser(user);
		appResource.setExpressionConvert(_expressionConvert);
		appResource.setFilterParserProvider(_filterParserProvider);
		appResource.setGroupLocalService(_groupLocalService);
		appResource.setResourceActionLocalService(_resourceActionLocalService);
	...
	private static final Function<InvocationHandler, AppResource>
		_appResourceProxyProviderFunction = _getProxyProviderFunction();

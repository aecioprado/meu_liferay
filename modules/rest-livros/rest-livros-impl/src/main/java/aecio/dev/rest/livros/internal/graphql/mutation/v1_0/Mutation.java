package aecio.dev.rest.livros.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	public App addApp(@GraphQLName("app") App app) throws Exception {
		return _applyComponentServiceObjects(
			_appResourceComponentServiceObjects, this::_populateResourceContext,
			appResource -> appResource.addApp(app));
	}
	...
	public App updateApp(
		...
		return _applyComponentServiceObjects(
			_appResourceComponentServiceObjects, this::_populateResourceContext,
			appResource -> appResource.updateApp(appId, app));
	}
